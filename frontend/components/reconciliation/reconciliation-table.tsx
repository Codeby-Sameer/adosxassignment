        ...
        <Table>
          <TableHeader>
            <TableRow className="border-b border-slate-200 dark:border-zinc-800 bg-slate-50/60 dark:bg-zinc-900/40">
              ...
              <TableHead className="w-[100px] text-center">Tenant</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {disagreements.map((item, index) => {
              ...
              if (item.system_a_value !== null && item.system_b_value !== null) {
                const numA = parseFloat(String(item.system_a_value).replace(/,/g, ""));
                const numB = parseFloat(String(item.system_b_value).replace(/,/g, ""));
              ...
              return (
                <TableRow
                  key={rowKey}
                  className="hover:bg-slate-50/90 dark:hover:bg-zinc-900/70 transition-colors"
                >
